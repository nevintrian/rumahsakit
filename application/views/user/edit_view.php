                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="level" class="form-control" required="required">
                                            <?php if ($this->session->userdata('level') == 'Kepala Rekam Medik') { ?>
                                                <option <?php if ($user->level == 'Kepala Rekam Medik') {
                                                            echo 'selected';
                                                        } ?>>Kepala Rekam Medik</option>
                                                <option <?php if ($user->level == 'Dokter Poliklinik') {
                                                            echo 'selected';
                                                        } ?>>Dokter Poliklinik</option>
                                                <option <?php if ($user->level == 'Kepala Poliklinik') {
                                                            echo 'selected';
                                                        } ?>>Kepala Poliklinik</option>
