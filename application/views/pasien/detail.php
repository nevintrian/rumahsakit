...
<body>
    ...
    <div id="printableArea">
        <page size="A4">
            <div class="panel pnel-default">
                <div class="panel-body bg-primary w-25 p-3">
                    <h4 class="text-center">KIB Pasien</h4>
                    <br />
                    <div class="row">
                        <div class="col-sm-8">
