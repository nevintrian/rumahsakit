...
class Registrasi extends CI_Controller
{
    ...
    public function index1()
    {
        ...
        if (!empty($this->session->userdata('no_rm'))) {
            $this->db->limit(1);
        ...
        // var_dump($data); die();
        $this->load->view('antrian/registrasi_view', $data);
    }
    ...
    public function registrasi()
    {
        ...
        $this->db->set('j_kel', $jenis_kelamin);
    ...
    public function proses_login()
    {
        ...
        $getpasien = $this->db->get('tabel_pasien')->row();

        if ($getpasien) {
            $this->session->set_userdata('no_rm', $getpasien->no_rm);
            $this->session->set_userdata('nama_pasien', $getpasien->nama_pasien);
