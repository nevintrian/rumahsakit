...
class User extends CI_Controller
{
	...
	public function print_kartu($id_login)
	{

		$data['cetak_kartu'] = $this->cetak->get_user_for_cetak($id_login)->row();

		$data['title_web'] = 'Print Kartu Petugas ';
	...
	// 		}
	// 	}
	// 	$this->data['title_web'] = 'Print Kartu Petugas ';
