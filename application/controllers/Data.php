...
class Data extends CI_Controller
{
	...
	public function index()
	{
		...
		$this->data['jenis_pasien'] =  $this->antrian->get_jenis_pasien()->result();

		$this->data['kunjungan'] =  $this->laporan->get_laporan_kunjungan()->result();

		$this->data['title_web'] = 'Data Laporan';
	...
	public function laporan_rm_pasien()
	{
		$this->data['idbo'] = $this->session->userdata('ses_id');
		...
		$this->data['join_rmpasien_pelayanan'] = $this->laporan->get_laporan_rm_pasien()->result();

		$this->data['title_web'] = 'Data Laporan';
		$this->load->view('header_view', $this->data);
		$this->load->view('sidebar_view', $this->data);
		$this->load->view('buku/laporan_rm_pasien_view', $this->data);
		$this->load->view('footer_view', $this->data);
	}

	public function laporan_rl4()
	{
		$this->data['idbo'] = $this->session->userdata('ses_id');
		...
		$this->data['data_poli'] = $this->poli->get_poli()->result();
		$this->data['laporan_rl4'] = $this->laporan->get_laporan_rl4()->result();

		$this->data['title_web'] = 'Data Laporan';
		$this->load->view('header_view', $this->data);
		$this->load->view('sidebar_view', $this->data);
		$this->load->view('buku/laporan_rl4', $this->data);
		$this->load->view('footer_view', $this->data);
	}

	public function pencarian_laporan_kunjungan() {

		$this->data['idbo'] = $this->session->userdata('ses_id');

		$bulan = $this->input->get('bulan');
		$tahun = $this->input->get('tahun');
		$jns_pasien = $this->input->get('jns_pasien');
		...
		$this->data['kunjungan'] =  $this->laporan->get_laporan_kunjungan_search($bulan, $tahun, $jns_pasien, $kunjungan)->result();
	...
	public function pencarian_laporan_rm_pasien() {
		...
		$this->data['jenis_pasien'] =  $this->antrian->get_jenis_pasien()->result();
		$this->data['data_poli'] = $this->poli->get_poli()->result();
		$this->data['join_rmpasien_pelayanan'] =  $this->laporan->get_laporan_rm_search($bulan, $tahun, $poli, $jns_pasien, $kunjungan)->result();
	...
	public function pencarian_laporan_rl4() {
		...
		$this->data['data_poli'] = $this->poli->get_poli()->result();
		$this->data['laporan_rl4'] =  $this->laporan->get_laporan_rl4_search($bulan, $tahun, $poli)->result();
	...
	public function cetak_all_laporan_kunjungan() {

		$bulan = $this->input->get('bulan');
		$tahun = $this->input->get('tahun');
		$j_pasien = $this->input->get('j_pasien');
		$kunjung = $this->input->get('kunjung');
		
		$data['kunjungan'] =  $this->laporan->get_laporan_kunjungan_search($bulan, $tahun, $j_pasien, $kunjung)->result();

		$this->load->view('buku/cetak_all_kunjungan', $data);
	}

	public function cetak_all_laporan_rm_pasien() {

		$bulan = $this->input->get('bulan');
		$tahun = $this->input->get('tahun');
		$poli = $this->input->get('n_poli');
		$j_pasien = $this->input->get('j_pasien');
		$kunjung = $this->input->get('kunjung');
		
		$this->data['join_rmpasien_pelayanan'] =  $this->laporan->get_laporan_rm_search($bulan, $tahun, $poli, $j_pasien, $kunjung)->result();

		$this->load->view('buku/cetak_all_rm_pasien', $this->data);
	}

	public function cetak_all_laporan_rl4() {
		...
		$this->load->view('buku/cetak_all_rl4', $this->data);
	}

	public function cetak_laporan_rm_pasien($id_daftar) {

		$this->data['rows'] =  $this->laporan->get_laporan_rm_per_pasien($id_daftar)->row();

		$this->load->view('buku/cetak_laporan_rm_pasien', $this->data);

	}

	public function cetak_laporan_rl4($id_daftar) {

		$this->data['laporan_rl4'] = $this->laporan->get_laporan_rl4($id_daftar)->row();

		$this->load->view('buku/cetak_laporan_rl4', $this->data);
	...
	public function cetaklaporanbaru()
	{
		$this->data['idbo'] = $this->session->userdata('ses_id');
		...
		$this->data['title_web'] = 'Data Laporan Kunjungan Pasien';
		$this->load->view('header_view', $this->data);
		$this->load->view('sidebar_view', $this->data);
		$this->load->view('buku/cetakbaru', $this->data);
		$this->load->view('footer_view', $this->data);
	}

	public function cetaklaporanlama()
	{
		$this->data['idbo'] = $this->session->userdata('ses_id');
		$count = $this->M_Admin->CountTableId('tbl_buku', 'id_buku', $this->uri->segment('3'));
		if ($count > 0) {
		...
		$this->load->view('header_view', $this->data);
		$this->load->view('sidebar_view', $this->data);
		$this->load->view('buku/cetaklama', $this->data);
		$this->load->view('footer_view', $this->data);
	}
