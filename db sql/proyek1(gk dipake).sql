...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 10, 2021 at 06:48 AM
...
--
ALTER TABLE `tabel_kunjung`
  MODIFY `id_kunjung` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `tabel_pasien`
--
ALTER TABLE `tabel_pasien`
  MODIFY `no_rm` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40002;
...
--
ALTER TABLE `tabel_poli`
  MODIFY `id_poli` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
